...
const Solutions: React.FC = () => {
  ...
  return (
    <Section className="py-20 bg-gray-50 relative overflow-hidden" id="solutions">
      {/* Cloud Animation Elements */}
      <div className="absolute top-20 left-10 w-20 h-12 bg-white rounded-full opacity-70 animate-float" style={{ animationDelay: '0s' }}></div>
      <div className="absolute top-32 right-20 w-24 h-16 bg-white rounded-full opacity-60 animate-float" style={{ animationDelay: '2s' }}></div>
      <div className="absolute bottom-24 left-1/4 w-16 h-10 bg-white rounded-full opacity-50 animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute top-1/2 right-10 w-28 h-16 bg-white rounded-full opacity-40 animate-float" style={{ animationDelay: '3s' }}></div>
      <div className="absolute bottom-40 right-1/3 w-20 h-12 bg-white rounded-full opacity-30 animate-float" style={{ animationDelay: '4s' }}></div>
      
      <Container>
        <div className="text-center mb-16 relative z-10">
          <span className="inline-block px-4 py-2 rounded-full bg-blue-50 text-skyblue text-sm font-medium mb-4 animate-fade-in">Cloud Solutions</span>
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-txtblack animate-fade-up" style={{ animationDelay: '300ms' }}>Tailored Services for Your Business</h2>
          <p className="text-gray-600 max-w-2xl mx-auto animate-fade-up" style={{ animationDelay: '500ms' }}>Choose the cloud delivery model that best fits your organization's needs.</p>
        </div>
        ...
        <div className="flex flex-col gap-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-white rounded-2xl p-8 border border-gray-100 shadow-lg animate-scale-in">
